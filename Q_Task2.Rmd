...
```
Looks like the customers is significantly higher in all 3 months. Thus we can say that the trial had a significant impact on increasing the number of customers for this trial store but as we saw, sales were not significantly higher. 
